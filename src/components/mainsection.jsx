...
function MainSection(){
    return(
        <section className='main-section m-auto flex'>
            <div className='mt-8 m-auto sm:2/2 lg:w-1/2'>
            ...
            <div className='sm:2/2 lg:w-1/2'>
                <div className='grid lg:gap-4 mt-8 grid-cols-7 lg:auto-cols-auto'>
                        ...
                        <h4 className='col-start-2 col-start-2 col-span-7 font-medium'>Track company-wide progress</h4>
                ...
                <h3 className='lg:col-start-1 mb-2 sm:col-span-1 text-xl font-medium'>02</h3>
                        <h4 className='col-start-2 col-start-2 col-span-7 font-medium'>Advanced built-in reports</h4>
                ...
                <h3 className='lg:col-start-1 mb-2 sm:col-span-1 text-xl font-medium'>03</h3>
                        <h4 className='col-start-2 col-start-2 col-span-7 font-medium'>Everything you need in one place</h4>
